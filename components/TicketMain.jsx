...
export default function TicketMain({ ticket, note, userId }) {
 ...
 return (
  <div className="mt-6 pr-10 pl-10 md:pl-0 space-y-4 overflow-auto">
    ...
    <Card className="">
     <CardHeader>
      <div className="space-y-2">
       ...
       <p className={`inline-flex py-2 px-4 rounded-lg ${statusColor}`}>
        {status}
       </p>
      </div>
     ...
     <CardContent>
      ...
      <p>
       {assignedTo ? (
        ...
        <span className="bg-purple-50 py-1 px-2 rounded-md">Unassigned</span>
       )}
      </p>
